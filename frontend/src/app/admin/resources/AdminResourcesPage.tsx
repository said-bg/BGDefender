...
import useAdminResources from '@/features/admin/resources/useAdminResources';
import { getAdminResourceUserLabel } from '@/features/admin/resources/adminResources.utils';
import styles from '@/features/admin/resources/AdminResourcesPage.module.css';
              ...
              <div className={styles.fieldGroup}>
                ...
                <div className={styles.uploadBox}>
                  <label className={styles.uploadLabel}>
                    {isUploading
                      ? t('resources.uploading', { defaultValue: 'Uploading document...' })
                      : t('resources.uploadCta', { defaultValue: 'Choose a document to upload' })}
                    <input
                ...
                <article key={resource.id} className={styles.resourceCard}>
                  <div className={styles.resourceTop}>
                    ...
                    <div className={styles.badgeRow}>
                      ...
                      >
                        {resource.source === ResourceSource.ADMIN
                          ? t('resources.sourceAdmin', { defaultValue: 'Sent by admin' })
                          : t('resources.sourceUser', { defaultValue: 'Uploaded by user' })}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className={styles.resourceActions}>
                    {resource.type === ResourceType.FILE && resource.fileUrl ? (
                      ...
                      >
                        {t('resources.openFile', { defaultValue: 'Open document' })}
                      </a>
                    ) : null}
