...
import courseService, { Author, Course } from '@/services/courseService';
import type { TranslationFn } from '@/types/i18n';
import { getApiErrorMessage } from '@/utils/apiError';
import { CoverImageMode, EditCourseFormState, initialFormState } from './types';
import {
...
import { loadCourseDetailsPageData } from './details.data';
